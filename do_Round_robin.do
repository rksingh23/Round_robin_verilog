...
vlog Round_Robin_4.v
vlog -work work tb_Round_Robin_4.v

# Loads a new design into the simulator
vsim -gui -novopt work.tb_Round_Robin_4
...
add wave -position insertpoint sim:/tb_Round_Robin_4/*
add wave -position insertpoint sim:/tb_Round_Robin_4/dut/state
add wave -position insertpoint sim:/tb_Round_Robin_4/dut/temp
add wave -position insertpoint sim:/tb_Round_Robin_4/dut/LRU
